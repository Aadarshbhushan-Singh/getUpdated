      ...
      const sendEmail = (e) => {
            ...
            if(name === ''){
                  ...
                  alert("Let's start engaging discussions! To enable me to respond to your comments, kindly share your opinions.")
                        ...
                        alert("I'have received your message. Will get in touch with you as soon as possible. Thanks!")
                  ...
                  <div className="container contact__container">
                        <div className="contact__options">
                              <article className="contact__option">
                                    ...
                                    <a href="mailto:singhaadarsh5050@gmail.com" rel="noopener noreferrer" target="_blank">Send a message</a>
                              </article>
                              ...
                              <article className="contact__option">
                                    ...
                                    <h4>Whatsapp</h4>
                                    <h5>+91 7634868809</h5>
                                    <a href="https://wa.me/+917634868809?text=Hi" rel="noopener noreferrer" target="_blank">Send a message</a>
                              </article>
                              ...
                              <article className="contact__option">
                                    ...
                                    <h4>Messenger</h4>
                                    <h5>Aadarsh Singh</h5>
                                    <a href="https://m.me/100005524576316" rel="noopener noreferrer" target="_blank">Send a message</a>
                              </article>
                        ...
                        <form ref={form}>
                              <input type="text" name="name" id="name" placeholder="Your Full Name" onChange={handleInputChangeName} value={name}/>
                              <input type="email" name="email" id="email" placeholder="Your Email" onChange={handleInputChangeEmail} value={email}/>
